...
@WebServlet("/EnviormentalDataViewerUmea")
public class EnviormentalDataViewerUmea extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   json=mongoDbClient.getSensorData("EnviormentalData_01");
	   JSONObject json2 = null;
		try {
			json2 = new JSONObject(json);
		} catch (JSONException e) {
		...
		try {
				...
				htmlString+="<th>PM10 (ugm3)</th>";		
				htmlString+="<th>NO2 (ugm3)</th>";	
				htmlString+="</tr>";
