...
@WebServlet("/EnvironmentalDataViewerS2")
public class EnviormentalDataViewerS2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    {
	    	json=mongoDbClient.getSensorData("EnvironmentalSensor_S2");
	    	...
	    	try {
	 	    ...
	 	    json=mongoDbClient.getSensorData("EnvironmentalSensor_S2",skip,limit);
