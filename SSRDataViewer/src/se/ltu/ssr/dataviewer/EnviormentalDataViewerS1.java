...
@WebServlet("/EnvironmentalDataViewerS1")
public class EnviormentalDataViewerS1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    {
	    	json=mongoDbClient.getSensorData("EnviormentalSensor_S1");
	    	...
	    	try {
	 	    ...
	 	    json=mongoDbClient.getSensorData("EnviormentalSensor_S1",skip,limit);
